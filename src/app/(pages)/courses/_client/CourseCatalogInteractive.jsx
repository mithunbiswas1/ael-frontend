...
export const COURSE_CATALOG = [
  ...
  {
    id: 3,
    title: "Safe Auto Gas Station Operations",
    description: "Dispenser safety, leak detection systems, static electricity grounding and emergency protocols.",
    category: "auto-gas",
    badge: "FREE",
    badgeColor: "bg-amber-500",
  ...
  },
  {
    ...
    description: "Master bulk storage management, vaporizers, manifold safety, piping codes and leak response.",
    category: "industrial",
    badge: "PAID",
  ...
  {
    id: 5,
    title: "LPG Emergency Response & Fire Hazard Control",
    description: "Tactical response protocols for major leaks, BLEVE prevention, and fire suppression.",
    category: "emergency",
    badge: "PAID",
    badgeColor: "bg-primary",
...
export default function CourseCatalogInteractive() {
